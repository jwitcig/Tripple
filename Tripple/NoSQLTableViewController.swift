...
class NoSQLTableViewController: UITableViewController {
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        // Queries
        if ((indexPath as NSIndexPath).section >= 1 && (indexPath as NSIndexPath).section < table!.indexes.count + 1) {
            let index = table!.indexes[(indexPath as NSIndexPath).section - 1]
            cell.queryType = index.supportedOperations()[(indexPath as NSIndexPath).row]
