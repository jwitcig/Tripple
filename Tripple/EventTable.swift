...
class CloudEventTable: NSObject, Table {
    ...
    override init() {
        ...
        indexes = [
            ...
            CloudEventPrimaryIndex(),

            CloudEventPinTimestampIndex(),
        ]
    ...
    func tableAttributeName(dataObjectAttributeName: String) -> String {
        return CloudEvent.JSONKeyPathsByPropertyKey()[dataObjectAttributeName] as! String
    }
    ...
    func getItemWithCompletionHandler(completionHandler: (response: AWSDynamoDBObjectModel?, error: NSError?) -> Void) {
        ...
        objectMapper.load(CloudEvent.self, hashKey: AWSIdentityManager.defaultIdentityManager().identityId!, rangeKey: 1111500000, completionHandler: {(response: AWSDynamoDBObjectModel?, error: NSError?) -> Void in
    ...
    func scanWithCompletionHandler(completionHandler: (response: AWSDynamoDBPaginatedOutput?, error: NSError?) -> Void) {
        ...
        objectMapper.scan(CloudEvent.self, expression: scanExpression, completionHandler: {(response: AWSDynamoDBPaginatedOutput?, error: NSError?) -> Void in
            dispatch_async(dispatch_get_main_queue(), {
                completionHandler(response: response, error: error)
            })
        })
    ...
    func insertSampleDataWithCompletionHandler(completionHandler: (errors: [NSError]?) -> Void) {
        ...
        itemForGet._pinId = NoSQLSampleDataGenerator.randomPartitionSampleStringWithAttributeName("pinId")
        itemForGet._previousEventId = NoSQLSampleDataGenerator.randomSampleStringWithAttributeName("previousCloudEventId")
        ...
        for _ in 1..<numberOfObjects {
            ...
            let item: CloudEvent = CloudEvent()
            ...
            item._pinId = NoSQLSampleDataGenerator.randomPartitionSampleStringWithAttributeName("pinId")
            item._previousEventId = NoSQLSampleDataGenerator.randomSampleStringWithAttributeName("previousCloudEventId")
    ...
    func removeSampleDataWithCompletionHandler(completionHandler: (errors: [NSError]?) -> Void) {
        ...
        objectMapper.query(CloudEvent.self, expression: queryExpression) { (response: AWSDynamoDBPaginatedOutput?, error: NSError?) -> Void in
            if let error = error {
                dispatch_async(dispatch_get_main_queue(), {
    ...
    func updateItem(item: AWSDynamoDBObjectModel, completionHandler: (error: NSError?) -> Void) {
        ...
        let itemToUpdate: CloudEvent = item as! CloudEvent
        ...
        itemToUpdate._pinId = NoSQLSampleDataGenerator.randomPartitionSampleStringWithAttributeName("pinId")
        itemToUpdate._previousEventId = NoSQLSampleDataGenerator.randomSampleStringWithAttributeName("previousCloudEventId")
...
class CloudEventPrimaryIndex: NSObject, Index {
    ...
    func queryWithPartitionKeyWithCompletionHandler(completionHandler: (response: AWSDynamoDBPaginatedOutput?, error: NSError?) -> Void) {
        ...
        objectMapper.query(CloudEvent.self, expression: queryExpression, completionHandler: {(response: AWSDynamoDBPaginatedOutput?, error: NSError?) -> Void in
            dispatch_async(dispatch_get_main_queue(), {
                completionHandler(response: response, error: error)
            })
        })
...
class CloudEventPinTimestampIndex: NSObject, Index {
    
    var indexName: String? {

        return "Pin-Timestamp-Index"
    }
    ...
    func queryWithPartitionKeyDescription() -> String {
        return "Find all items with pinId = \("demo-pinId-3")."
    }
    ...
    func queryWithPartitionKeyWithCompletionHandler(completionHandler: (response: AWSDynamoDBPaginatedOutput?, error: NSError?) -> Void) {
        ...
        queryExpression.indexName = "Pin-Timestamp-Index"
        queryExpression.keyConditionExpression = "#pinId = :pinId"
        queryExpression.expressionAttributeNames = ["#pinId": "pinId",]
        queryExpression.expressionAttributeValues = [":pinId": "demo-pinId-3",]
    ...
    func queryWithPartitionKeyAndFilterDescription() -> String {
        return "Find all items with pinId = \("demo-pinId-3") and latitude > \(1111500000)."
    }
    ...
    func queryWithPartitionKeyAndSortKeyDescription() -> String {
        return "Find all items with pinId = \("demo-pinId-3") and timestamp < \(1111500000)."
    }
    ...
    func queryWithPartitionKeyAndSortKeyWithCompletionHandler(completionHandler: (response: AWSDynamoDBPaginatedOutput?, error: NSError?) -> Void) {
        ...
        queryExpression.indexName = "Pin-Timestamp-Index"
        queryExpression.keyConditionExpression = "#pinId = :pinId AND #timestamp < :timestamp"
        queryExpression.expressionAttributeNames = [
            "#pinId": "pinId",
            "#timestamp": "timestamp",
        ]
    ...
    func queryWithPartitionKeyAndSortKeyAndFilterDescription() -> String {
        return "Find all items with pinId = \("demo-pinId-3"), timestamp < \(1111500000), and latitude > \(1111500000)."
    }
